...
---DELETE FROM TB_PRODUTOS WHERE COD_PROD = 14
...
FROM       TB_USUARIOS AS USU
INNER JOIN TB_FUNCIONARIOS AS FUNC
ON         USU.COD_USU = FUNC.COD_FUNCIONARIO
WHERE      FUNC.NOME LIKE '%S';
